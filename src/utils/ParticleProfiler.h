...
/**
 *
 * This class offers a component which divides the system into bins along the x-axis.
 * It calculates the density and average velociy of the particles for each bin.
 */
class ParticleProfiler {
     ...
     * @param number_of_bins: The number of bins in which the system should be divided.
    ...
    /**
     * @brief Checks if the header is written to ensure that the header is only written once.
     */
