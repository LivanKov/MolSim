...
class boundary_condition_type: public ::xml_schema::string
{
  ...
  operator= (const boundary_condition_type&) = default;
#endif
...
class MolSim: public ::xml_schema::type
{
  ...
  void
  simulation_parameters (::std::unique_ptr< simulation_parameters_type > p);
  ...
  MolSim (::std::unique_ptr< simulation_parameters_type >);
...
class simulation_parameters: public ::xml_schema::type
{
  ...
  void
  output_basename (::std::unique_ptr< output_basename_type > p);
...
class domain_size: public ::xml_schema::type
{
  ...
  void
  lower_left_corner (::std::unique_ptr< lower_left_corner_type > p);
