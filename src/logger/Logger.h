...
/**
 * @class Logger.
 * @brief A (singleton) Logger class for logging operations though out the application.
 * This class provides various logging methods for any specific log-level
 * (trace, debug, info, warn, error, off).
 * Using the singleton pattern to ensure that only one instance of the logger is created.
 * The class uses the spdlog library.
 */
class Logger {
public:
    /**
