...
public:
  ...
  * @param delta_temperature Maximum absolute temperature change per application.
  * @param gradual Whether thermostat should apply gradually or directly towards/to target temperature.
  ...
  *
  * It can heat, cool or hold the temperature of the systems with respect to the parameters specified.
  * This is done by scaling the particles' velocities appropriate.
  */
 void apply();
  ...
  *
  * Applying the scaling factor formula here. Is used to calculate new velocity of particles.
  *
  * @param new_temperature To this temperature should the particles' velocities gets scaled.
  */
  ...
  *
  * This method ensures that the particles are getting initialized with brownian motion when
  * enable_brownian = true. The method is used in the constructor.
  */
 ...
 /**
  * @brief Scales particles' velocities directly with respect to initial temperature.
  *
  * Helper method primarily for testing purposes. Scales particles_ directly to the velocities in
  * regard to the initial temperature.
  */
 void initialize();
...
private:
 ...
 /** @brief Whether thermostat should apply gradually or directly towards/to target temperature. */
 bool gradual_;

 /** @brief Scaling factor used to adjust particles' velocities based on temperature. */
